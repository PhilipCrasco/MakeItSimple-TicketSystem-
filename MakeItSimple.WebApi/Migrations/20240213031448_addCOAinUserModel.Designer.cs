...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20240213031448_addCOAinUserModel")]
    partial class addCOAinUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.User", b =>
                {
                    ...
                    b.Property<int?>("AccountTitleId")
                        .HasColumnType("int")
                        .HasColumnName("account_title_id");
                    ...
                    b.HasIndex("AccountTitleId")
                        .HasDatabaseName("ix_users_account_title_id");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.User", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.AccountTitleSetup.AccountTitle", "AccountTitle")
                        .WithMany()
                        .HasForeignKey("AccountTitleId")
                        .HasConstraintName("fk_users_account_titles_account_title_id");
