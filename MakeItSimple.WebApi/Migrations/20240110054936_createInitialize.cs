        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sub_unit_id = table.Column<int>(type: "int", nullable: false),
                    channel_id = table.Column<int>(type: "int", nullable: false),
                    channel_user_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_ticket_transactions_departments_department_id",
                        column: x => x.department_id,
                        principalTable: "departments",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_closing_t_attachments_ticket_concern_id",
                table: "closing_t_attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_concerns_ticket_transaction_id",
                table: "ticket_concerns",
                column: "ticket_transaction_id");

            migrationBuilder.CreateIndex(
                name: "ix_ticket_transactions_added_by",
                table: "ticket_transactions",
                column: "added_by");

            migrationBuilder.CreateIndex(
                name: "ix_ticket_transactions_approved_by",
                table: "ticket_transactions",
                column: "approved_by");

            migrationBuilder.CreateIndex(
                name: "ix_ticket_transactions_department_id",
                table: "ticket_transactions",
                column: "department_id");

            migrationBuilder.CreateIndex(
                name: "ix_ticket_transactions_modified_by",
                table: "ticket_transactions",
                column: "modified_by");
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_closing_t_attachments_ticket_concerns_ticket_concern_id",
                table: "closing_t_attachments",
                column: "ticket_concern_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_ticket_concerns_ticket_transactions_ticket_transaction_id",
                table: "ticket_concerns",
                column: "ticket_transaction_id",
                principalTable: "ticket_transactions",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_ticket_transactions_users_added_by_user_id",
                table: "ticket_transactions",
                column: "added_by",
                principalTable: "users",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_ticket_transactions_users_approved_by_user_id",
                table: "ticket_transactions",
                column: "approved_by",
                principalTable: "users",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_ticket_transactions_users_modified_by_user_id",
                table: "ticket_transactions",
                column: "modified_by",
                principalTable: "users",
                principalColumn: "id",
