...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20231227033702_AddTeamAndChannelInSetups")]
    partial class AddTeamAndChannelInSetups
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", b =>
                {
                    ...
                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_channel_added_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_channel_modified_by");

                    b.HasIndex("TeamId")
                        .HasDatabaseName("ix_channel_team_id");

                    b.HasIndex("UserId1")
                        .HasDatabaseName("ix_channel_user_id1");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.TeamSetup.Team", b =>
                {
                    ...
                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_team_added_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_team_modified_by");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 27, 11, 37, 1, 902, DateTimeKind.Local).AddTicks(6813),
                            Email = "admin@gmail.com",
                            Fullname = "Admin",
                            IsActive = true,
                            Password = "$2a$11$.v3LliNkzKhlUYNPLC0Ybu3him.5AqclKf7ycm1ak336eNio7z4KG",
                            UserRoleId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.UserManagement.UserRoleAccount.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 11, 37, 2, 178, DateTimeKind.Local).AddTicks(4247),
                            IsActive = true,
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_channel_users_added_by_user_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_channel_users_modified_by_user_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.TeamSetup.Team", "Team")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_channel_team_team_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId1")
                        .HasConstraintName("fk_channel_users_user_id1");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.TeamSetup.Team", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_team_users_added_by_user_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_team_users_modified_by_user_id");
