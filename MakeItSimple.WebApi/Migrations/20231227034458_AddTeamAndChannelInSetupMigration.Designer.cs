...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20231227034458_AddTeamAndChannelInSetupMigration")]
    partial class AddTeamAndChannelInSetupMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", b =>
                {
                    ...
                    b.HasIndex("UserId1")
                        .HasDatabaseName("ix_channels_user_id1");
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 27, 11, 44, 58, 432, DateTimeKind.Local).AddTicks(8998),
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.UserManagement.UserRoleAccount.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 27, 11, 44, 58, 433, DateTimeKind.Local).AddTicks(3947),
                            IsActive = true,
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_channels_users_added_by_user_id");
