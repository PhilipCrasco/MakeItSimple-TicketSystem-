...
namespace MakeItSimple.WebApi.Migrations
{
    ...
    [Migration("20240118062633_AddTransferTicket")]
    partial class AddTransferTicket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Ticketing.TicketRequest.TransferTicketConcern", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_transfer_ticket_concern");

                    b.HasIndex("AddedBy")
                        .HasDatabaseName("ix_transfer_ticket_concern_added_by");

                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_transfer_ticket_concern_category_id");

                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_transfer_ticket_concern_channel_id");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_transfer_ticket_concern_modified_by");

                    b.HasIndex("SubCategoryId")
                        .HasDatabaseName("ix_transfer_ticket_concern_sub_category_id");

                    b.HasIndex("SubUnitId")
                        .HasDatabaseName("ix_transfer_ticket_concern_sub_unit_id");

                    b.HasIndex("TicketConcernId")
                        .HasDatabaseName("ix_transfer_ticket_concern_ticket_concern_id");

                    b.HasIndex("TransferBy")
                        .HasDatabaseName("ix_transfer_ticket_concern_transfer_by");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_transfer_ticket_concern_user_id");

                    b.ToTable("transfer_ticket_concern", (string)null);
                });
            ...
            modelBuilder.Entity("MakeItSimple.WebApi.Models.Ticketing.TicketRequest.TransferTicketConcern", b =>
                {
                    b.HasOne("MakeItSimple.WebApi.Models.User", "AddedByUser")
                        ...
                        .HasForeignKey("AddedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_transfer_ticket_concern_users_user_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.CategorySetup.Category", "Category")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transfer_ticket_concern_categories_category_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.ChannelSetup.Channel", "Channel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transfer_ticket_concern_channels_channel_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_transfer_ticket_concern_users_modified_by_user_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.SubCategorySetup.SubCategory", "SubCategory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transfer_ticket_concern_sub_categories_sub_category_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Setup.SubUnitSetup.SubUnit", "SubUnit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transfer_ticket_concern_sub_units_sub_unit_id");
                    ...
                    b.HasOne("MakeItSimple.WebApi.Models.Ticketing.TicketRequest.TicketConcern", "TicketConcern")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transfer_ticket_concern_ticket_concerns_ticket_concern_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "TransferByUser")
                        .WithMany()
                        .HasForeignKey("TransferBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_transfer_ticket_concern_users_transfer_by_user_id");

                    b.HasOne("MakeItSimple.WebApi.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_transfer_ticket_concern_users_user_id1");
